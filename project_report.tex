...
As the use of artificial intelligence continues to expand into the realm of image compression\footnote{\url{https://ai.googleblog.com/2016/09/image-compression-with-neural-networks.html}}\footnote{\url{http://www.wave.one/icml2017/}}, questions are being raised on how well the original artefacts and nature of the source image are preserved. The consequences of being able to utilize smaller output images that maintain the majority of pertinent information from their often signifantly larger source images are huge. With smaller inputs, applications from self driving cars that rely on camera input, autonomous flight, through to training neural networks could require significantly less processing time and resources.
...
blurred to the extent that they became unrecognizeable and
...
specific definition of accuracy using group or mechanical turk\footnote{See: https://www.mturk.com/} rankings and labelling of images. This would provide us with a more reliable and scaleable \textquote{ground truth} for understanding the accuracy of Google Cloud Vision API's classification of
...
stickers, random noise, etc. are added to images or scences, causing
