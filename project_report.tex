...
\bgroup
\def\arraystretch{1.5} % stretches table vertically
...
the labels it was assigned were. In addition, each form of image
...
causing neural networks to misclassify them.\footnote{\url{https://openreview.net/pdf?id=S10qYwywf}}
\footnote{\url{https://www.researchgate.net/publication/315890594\_Dimensionality\_Reduction\_as\_a\_Defense\_against\_Evasion\_Attacks\_on\_Machine\_ Learning\_Classifiers}}
